...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        book[1] = new Book("Universe", "Piece and War" , " Tolstoy", 1020);
        book[2] = new Book( "Youth", "Master and Margarita", "Bylgakov", 300);
        book[3] = new Book( "Youth", "Red hat", "Andersen", 270);
        book[4] = new Book( "Universe", "Dandelion vine", "Bredberi", 745 );
        book[5] = new Book( "White wind", "Dead souls", "Gogol", 636);
    ...
    public static void menu( Book[] book, Magazine[]magazine, Newspaper[]newspaper){
        ...
        while ( true ){
            ...
            choice = in.nextInt();
            switch( choice ) {
                case 1:  showKonsolBook(book);break;
                case 2: showKonsolMagazine(magazine);break;
                case 3: showKonsolNewspapers(newspaper);break;
    ...
    public static void showKonsolBook(Book[]book){ //вывод информации о книгах на консоль
        for (int i = 0; i < book.length; i++) {
            book[i].showTheInformation();
        }
    }

    public static void showKonsolMagazine(Magazine[]magazine) { //вывод информации о журналах на консоль
        for (int i = 0; i < magazine.length; i++) {
            magazine[i].showTheInformation();
        }
    }

    public static void showKonsolNewspapers(Newspaper[]newspaper) { //вывод информации о газетах на консоль
